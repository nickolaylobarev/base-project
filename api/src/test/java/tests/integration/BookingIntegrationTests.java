...
public class BookingIntegrationTests extends BaseTest {
    ...
    public static void setSpecification() {
        installSpecification(requestSpec(bookerUrl), responseSpecOK200or201());
    }
    ...
    public void getBookingTest() throws IOException {
        ...
        System.out.println(toJson(randomBooking));
...
//                });
    ...
    public void createBookingTest() {
        ...
        Assertions.assertEquals("TestFirstName-" + randomIdentifier + "-autotests", bookingSuccessResponse.getBooking().getFirstname());
